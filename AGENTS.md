...
For proposals/specs/plans, new capabilities, breaking changes, architecture shifts, or behavior-changing perf/security work, follow the spec workflow in `@/docs/spec/AGENTS.md`. Stage 1 proposals live under `docs/spec/changes/<id>-YYYY-MM-DD/`; truth specs after archive live under `docs/spec/specs/`.
<!-- SPEC:END -->
